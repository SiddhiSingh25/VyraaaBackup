        ...
        <div className="w-full animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-full rounded-md border border-primary bg-background px-4 py-2 text-sm text-heading outline-none focus:ring-1 focus:ring-primary"
            />
      ...
      <main className="flex-1 overflow-y-auto">
        <form onSubmit={handleSubmit(onSubmit)} className="mx-auto flex h-full max-w-6xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between bg-surface p-6 rounded-xl border border-border shadow-sm">
            <div>
              <h2 className="text-3xl font-semibold text-heading font-heading tracking-wide">Master Builder</h2>
            ...
            <div className="flex flex-col gap-8">
              ...
              <section className="rounded-xl border border-border bg-surface p-6 shadow-sm md:p-8">
                <div className="flex items-center gap-3 border-b border-border pb-4 mb-6">
                  ...
                  <h3 className="text-xl text-heading font-heading">Classification</h3>
                </div>
              ...
              <section className="rounded-xl border border-border bg-surface p-6 shadow-sm md:p-8">
                <div className="flex items-center gap-3 border-b border-border pb-4 mb-6">
                  ...
                  <h3 className="text-xl text-heading font-heading">Dependent Properties</h3>
                </div>
            ...
            <div className="flex flex-col gap-8">
              ...
              <section className="rounded-xl border border-border bg-surface p-6 shadow-sm md:p-8">
                <div className="flex items-center gap-3 border-b border-border pb-4 mb-6">
                  ...
                  <h3 className="text-xl text-heading font-heading">Color Standards</h3>
                </div>
                ...
                {colors.length > 0 && (
                  <div className="mt-4 flex flex-wrap gap-2">
                    {colors.map((color, idx) => (
                      <span key={idx} className="inline-flex items-center gap-2 rounded-full border border-border bg-background px-3 py-1.5 text-sm text-heading shadow-sm font-medium">
              ...
              <section className="rounded-xl border border-border bg-surface p-6 shadow-sm md:p-8">
                <div className="flex items-center gap-3 border-b border-border pb-4 mb-6">
                  ...
                  <h3 className="text-xl text-heading font-heading">Sizing Standards</h3>
                </div>
                ...
                {sizes.length > 0 && (
                  <div className="mt-4 flex flex-wrap gap-2">
                    {sizes.map((size, idx) => (
                      <span key={idx} className="inline-flex items-center gap-2 rounded-md border border-border bg-background px-3 py-1 text-sm font-semibold text-heading shadow-sm">
                        {size}
