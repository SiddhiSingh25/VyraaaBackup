...
export default function SubCategoryTypeFormModal({
  isOpen,
  mode,
  subcategories,
  initialData,
      ...
      >
        ...
        <div className="sm:col-span-2">
          ...
          <input
            ...
            placeholder="e.g. Top"
            className={`w-full rounded-lg border px-3.5 h-10 text-sm text-dark-900 ${errors.type ? "border-red-300" : "border-dark-200"}`}
          />
          {errors.type && (
            <p className="mt-1 text-xs font-medium text-red-500">
              {errors.type}
