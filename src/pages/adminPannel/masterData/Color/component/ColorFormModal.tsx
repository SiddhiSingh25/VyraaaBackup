...
export default function ColorFormModal({
  ...
  return (
    <Modal
      ...
      description={mode === "add" ? "Create a new color." : "Update color."}
      footer={
        <>
      ...
      >
        <div className="sm:col-span-2">
          ...
          <select
            ...
            className={`w-full rounded-lg border px-3.5 h-10 text-sm text-dark-900 ${errors.family ? "border-red-300" : "border-dark-200"}`}
          >
        ...
        <div>
          ...
          <input
            ...
            className={`w-full rounded-lg border px-3.5 h-10 text-sm text-dark-900 ${errors.color ? "border-red-300" : "border-dark-200"}`}
          />
          {errors.color && (
            <p className="mt-1 text-xs font-medium text-red-500">
              {errors.color}
        ...
        <div>
          ...
          <input
            ...
            placeholder="#FF2400"
            className="w-full rounded-lg border px-3.5 h-10 text-sm text-dark-900 border-dark-200"
          />
        </div>
      </form>
    </Modal>
